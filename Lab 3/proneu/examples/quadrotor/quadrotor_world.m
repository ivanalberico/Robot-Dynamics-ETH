...
%%
%   File:           quadrotor_world.m
%
%   Authors:        Vassilios Tsounis, tsounisv@ethz.ch
%
%   Date:           10/12/2016
%
%   Desciption:     Simulation world for a quadrotor.
%
...
element(k).geometry.offsets.r = [0 0 1].';
...
world_name = 'QuadRotorWorld';

% Generate the world model object
worldmdl = WorldModel(element, @quadrotor_world_environemnt, 'name', world_name);
