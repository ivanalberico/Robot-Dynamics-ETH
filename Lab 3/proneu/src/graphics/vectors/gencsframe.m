...
function [ obj ] = gencsframe(ax, name, scale, fontsize)
    ...
    hold(ax,'on');
    obj{1} = quiver3(csf_x,csf_y,csf_z,csf_u(2),csf_v(2),csf_w(2),0, ...
                'visible','off','Parent',ax);
    obj{2} = quiver3(csf_x,csf_y,csf_z,csf_u(3),csf_v(3),csf_w(3),0, ...
                'visible','off','Parent',ax);
    obj{3} = quiver3(csf_x,csf_y,csf_z,csf_u(4),csf_v(4),csf_w(4),0, ...
                'visible','off','Parent',ax);
    hold(ax,'off');
